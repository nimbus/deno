...
impl DebugOptions {
  ...
  pub fn check_options(&mut self, errors: &mut Vec<String>) {
    let entries: Vec<&str> =
      self.inspect_publish_uid_string.split(',').collect();
    ...
    for entry in entries {
      ...
      match destination {
        ...
        _ => errors.push(
          "--inspect-publish-uid destination can be stderr or http".to_string(),
        ),
      }
    }
...
impl EnvironmentOptions {
  pub fn check_options(&mut self, errors: &mut Vec<String>) {
    ...
    if self.heap_snapshot_near_heap_limit < 0 {
      errors.push(
        "--heapsnapshot-near-heap-limit must not be negative".to_string(),
      );
    }
    ...
    if self.test_runner {
      ...
      if self.syntax_check_only {
        errors
          .push("either --test or --check can be used, not both".to_string());
      }

      if self.has_eval_string {
        errors
          .push("either --test or --eval can be used, not both".to_string());
      }

      if self.force_repl {
        errors.push(
          "either --test or --interactive can be used, not both".to_string(),
        );
      }

      if !self.watch_mode_paths.is_empty() {
        errors.push(
          "--watch-path cannot be used in combination with --test".to_string(),
        );
      }
    }
    ...
    if self.watch_mode {
      if self.syntax_check_only {
        errors
          .push("either --watch or --check can be used, not both".to_string());
      } else if self.has_eval_string {
        errors
          .push("either --watch or --eval can be used, not both".to_string());
      } else if self.force_repl {
        errors.push(
          "either --watch or --interactive can be used, not both".to_string(),
        );
      } else if self.test_runner_force_exit {
        errors.push(
          "either --watch or --test-force-exit can be used, not both"
            .to_string(),
        );
      }
    ...
    if !self.cpu_prof {
      ...
      if self.cpu_prof_interval != 1000 {
        errors
          .push("--cpu-prof-interval must be used with --cpu-prof".to_string());
      }
    }

    if self.cpu_prof
      && self.cpu_prof_dir.is_empty()
      && !self.diagnostic_dir.is_empty()
    {
    ...
    if !self.heap_prof {
      if !self.heap_prof_name.is_empty() {
        errors
          .push("--heap-prof-name must be used with --heap-prof".to_string());
      }
      if !self.heap_prof_dir.is_empty() {
        errors
          .push("--heap-prof-dir must be used with --heap-prof".to_string());
      }
      if self.heap_prof_interval != 512 * 1024 {
        errors.push(
          "--heap-prof-interval must be used with --heap-prof".to_string(),
        );
      }
    }

    if self.heap_prof
      && self.heap_prof_dir.is_empty()
      && !self.diagnostic_dir.is_empty()
    {
...
impl OptionsParser {
  ...
  fn set_boolean_field(
    ...
    match name {
      // Debug options
      "--inspect" => {
        options.per_isolate.per_env.debug_options.inspector_enabled = value
      }
      "--inspect-wait" => {
        options.per_isolate.per_env.debug_options.inspect_wait = value
      }
      "--debug" | "--debug-brk" => {
        options.per_isolate.per_env.debug_options.deprecated_debug = value
      }
      "--inspect-brk" => {
        options.per_isolate.per_env.debug_options.break_first_line = value
      }
      "--inspect-brk-node" => {
        options
          .per_isolate
      ...
      "--experimental-detect-module" => {
        options.per_isolate.per_env.detect_module = value
      }
      "--disable-sigusr1" => {
        options.per_isolate.per_env.disable_sigusr1 = value
      }
      "--experimental-print-required-tla" => {
        options.per_isolate.per_env.print_required_tla = value
      }
      "--experimental-require-module" => {
        options.per_isolate.per_env.require_module = value
      }
      "--enable-source-maps" => {
        options.per_isolate.per_env.enable_source_maps = value
      }
      ...
      "--allow-child-process" => {
        options.per_isolate.per_env.allow_child_process = value
      }
      "--allow-wasi" => options.per_isolate.per_env.allow_wasi = value,
      "--allow-worker" => {
        options.per_isolate.per_env.allow_worker_threads = value
      }
      "--experimental-repl-await" => {
      ...
      "--async-context-frame" => {
        options.per_isolate.per_env.async_context_frame = value
      }
      "--expose-internals" => {
        options.per_isolate.per_env.expose_internals = value
      }
      "--frozen-intrinsics" => {
        options.per_isolate.per_env.frozen_intrinsics = value
      }
      "--network-family-autoselection" => {
      ...
      "--global-search-paths" => {
        options.per_isolate.per_env.global_search_paths = value
      }
      "--warnings" => options.per_isolate.per_env.warnings = value,
      "--force-context-aware" => {
        options.per_isolate.per_env.force_context_aware = value
      }
      "--pending-deprecation" => {
        options.per_isolate.per_env.pending_deprecation = value
      }
      "--preserve-symlinks" => {
        options.per_isolate.per_env.preserve_symlinks = value
      }
      "--preserve-symlinks-main" => {
      ...
      "--insecure-http-parser" => {
        options.per_isolate.per_env.insecure_http_parser = value
      }
      "[has_env_file_string]" => {
        options.per_isolate.per_env.has_env_file_string = value
      }
      "--experimental-default-config-file" => {
      ...
      "--test-force-exit" => {
        options.per_isolate.per_env.test_runner_force_exit = value
      }
      "--test-update-snapshots" => {
      ...
      "--test-udp-no-try-send" => {
        options.per_isolate.per_env.test_udp_no_try_send = value
      }
      "--throw-deprecation" => {
        options.per_isolate.per_env.throw_deprecation = value
      }
      "--trace-deprecation" => {
        options.per_isolate.per_env.trace_deprecation = value
      }
      ...
      "--trace-env-js-stack" => {
        options.per_isolate.per_env.trace_env_js_stack = value
      }
      "--trace-env-native-stack" => {
      ...
      "--verify-base-objects" => {
        options.per_isolate.per_env.verify_base_objects = value
      }
      ...
      "[has_eval_string]" => {
        options.per_isolate.per_env.has_eval_string = value
      }
      ...
      "--report-exclude-env" => {
        options.per_isolate.per_env.report_exclude_env = value
      }
      "--report-exclude-network" => {
      ...
      "--report-uncaught-exception" => {
        options.per_isolate.report_uncaught_exception = value
      }
      "--report-on-signal" => options.per_isolate.report_on_signal = value,
      "--experimental-shadow-realm" => {
        options.per_isolate.experimental_shadow_realm = value
      }
      ...
      "--debug-arraybuffer-allocations" => {
        options.debug_arraybuffer_allocations = value
      }
      ...
      "--disable-wasm-trap-handler" => {
        options.disable_wasm_trap_handler = value
      }
  ...
  fn set_uinteger_field(
    ...
    match name {
      ...
      "--max-http-header-size" => {
        options.per_isolate.per_env.max_http_header_size = value
      }
      "--cpu-prof-interval" => {
        options.per_isolate.per_env.cpu_prof_interval = value
      }
      "--heap-prof-interval" => {
        options.per_isolate.per_env.heap_prof_interval = value
      }
      "--test-concurrency" => {
        options.per_isolate.per_env.test_runner_concurrency = value
      }
      "--test-timeout" => {
        options.per_isolate.per_env.test_runner_timeout = value
      }
      "--test-coverage-branches" => {
      ...
      "--test-coverage-lines" => {
        options.per_isolate.per_env.test_coverage_lines = value
      }
      _ => {
  ...
  fn set_string_field(
    ...
    match name {
      ...
      // Environment options
      "--dns-result-order" => {
        options.per_isolate.per_env.dns_result_order = value
      }
      "--diagnostic-dir" => options.per_isolate.per_env.diagnostic_dir = value,
      "--localstorage-file" => {
        options.per_isolate.per_env.localstorage_file = value
      }
      "--input-type" => options.per_isolate.per_env.input_type = value,
      "--heapsnapshot-signal" => {
        options.per_isolate.per_env.heapsnapshot_signal = value
      }
      ...
      "--redirect-warnings" => {
        options.per_isolate.per_env.redirect_warnings = value
      }
      "--env-file" => options.per_isolate.per_env.env_file = value,
      "--env-file-if-exists" => {
        options.per_isolate.per_env.optional_env_file = value
      }
      "--experimental-config-file" => {
      ...
      "--test-global-setup" => {
        options.per_isolate.per_env.test_global_setup_path = value
      }
      "--test-shard" => options.per_isolate.per_env.test_shard = value,
      "--trace-require-module" => {
        options.per_isolate.per_env.trace_require_module = value
      }
      "--unhandled-rejections" => {
        options.per_isolate.per_env.unhandled_rejections = value
      }
      "--watch-kill-signal" => {
        options.per_isolate.per_env.watch_mode_kill_signal = value
      }
      ...
      "--build-snapshot-config" => {
        options.per_isolate.build_snapshot_config = value
      }
  ...
  fn add_to_string_list_field(
    ...
    match name {
      ...
      "--allow-fs-read" => {
        options.per_isolate.per_env.allow_fs_read.push(value)
      }
      "--allow-fs-write" => {
        options.per_isolate.per_env.allow_fs_write.push(value)
      }
      "--allow-net" => options.per_isolate.per_env.allow_net.push(value),
      "--experimental-loader" => {
        options.per_isolate.per_env.userland_loaders.push(value)
      }
      "--disable-warning" => {
        options.per_isolate.per_env.disable_warnings.push(value)
      }
      "--test-name-pattern" => {
        options.per_isolate.per_env.test_name_pattern.push(value)
      }
      "--test-reporter" => {
        options.per_isolate.per_env.test_reporter.push(value)
      }
      "--test-reporter-destination" => options
        ...
        .push(value),
      "--test-skip-pattern" => {
        options.per_isolate.per_env.test_skip_pattern.push(value)
      }
      ...
      "--test-coverage-exclude" => options
        ...
        .push(value),
      "--watch-path" => {
        options.per_isolate.per_env.watch_mode_paths.push(value)
      }
      "--require" => {
        options.per_isolate.per_env.preload_cjs_modules.push(value)
      }
    ...
    while i < args.len() + synthetic_args.len() && errors.is_empty() {
      ...
      while expansion_count < 10 && current_name != "--" {
        if let Some(alias_expansion) = self.aliases.get(&current_name) {
          ...
          if let Some(alias_expansion) =
            self.aliases.get(&(current_name.clone() + "="))
          {
            if !alias_expansion.is_empty() {
              let new_name = alias_expansion[0].clone();
...
pub fn parse_node_options_env_var(
  ...
  while index < chars.len() {
    ...
    if c == '\\' && is_in_string {
      if index + 1 == chars.len() {
        errors
          .push("invalid value for NODE_OPTIONS (invalid escape)".to_string());
        return Err(errors);
      } else {
        index += 1;
        c = chars[index];
  ...
  if is_in_string {
    errors
      .push("invalid value for NODE_OPTIONS (unterminated string)".to_string());
    return Err(errors);
  }
...
mod tests {
  ...
  fn test_heap_prof_interval_without_heap_prof() {
    ...
    let errors = result.unwrap_err();
    assert!(errors.iter().any(|e| {
      e.contains("--heap-prof-interval must be used with --heap-prof")
    }));
  }
  ...
  fn test_negative_heapsnapshot_near_heap_limit() {
    ...
    let errors = result.unwrap_err();
    assert!(errors.iter().any(|e| {
      e.contains("--heapsnapshot-near-heap-limit must not be negative")
    }));
  }
  ...
  fn test_secure_heap_min_not_power_of_two() {
    let result =
      parse_args(svec!["--secure-heap", "4", "--secure-heap-min", "3"]);
    assert!(result.is_err());
    let errors = result.unwrap_err();
    assert!(
      errors
  ...
  fn test_invalid_inspect_publish_uid() {
    ...
    let errors = result.unwrap_err();
    assert!(errors.iter().any(|e| {
      e.contains("--inspect-publish-uid destination can be stderr or http")
    }));
  }
  ...
  fn test_valid_unhandled_rejections() {
    ...
    {
      let result =
        parse_args(svec!["--unhandled-rejections", rejection_type]).unwrap();
      assert_eq!(
  ...
  fn test_valid_trace_require_module() {
    for trace_type in &["all", "no-node-modules"] {
      let result =
        parse_args(svec!["--trace-require-module", trace_type]).unwrap();
      assert_eq!(
  ...
  fn test_valid_test_isolation() {
    for isolation_type in &["process", "none"] {
      let result =
        parse_args(svec!["--test", "--test-isolation", isolation_type])
          .unwrap();
      assert_eq!(
  ...
  fn test_valid_use_largepages() {
    for largepages_type in &["off", "on", "silent"] {
      let result =
        parse_args(svec!["--use-largepages", largepages_type]).unwrap();
  ...
  fn test_valid_inspect_publish_uid() {
    let result =
      parse_args(svec!["--inspect-publish-uid", "stderr,http"]).unwrap();
    assert!(
      result
        .options
        .per_isolate
  ...
  fn test_valid_secure_heap_power_of_two() {
    let result =
      parse_args(svec!["--secure-heap", "4", "--secure-heap-min", "2"])
        .unwrap();
  ...
  fn test_alias_loader_to_experimental_loader() {
    let result =
      parse_args(svec!["--loader", "./my-loader.js", "script.js"]).unwrap();
    assert_eq!(
  ...
  fn test_v8_option_max_semi_space_size() {
    let result =
      parse_args(svec!["--max-semi-space-size=64", "script.js"]).unwrap();
    assert!(
      result
        .v8_args
  ...
  fn test_script_with_args() {
    let result =
      parse_args(svec!["script.js", "arg1", "arg2", "--flag"]).unwrap();
    assert_eq!(
  ...
  fn test_options_before_script() {
    let result =
      parse_args(svec!["--no-warnings", "script.js", "--my-arg"]).unwrap();
    assert!(!result.options.per_isolate.per_env.warnings);
  ...
  fn test_test_concurrency_option() {
    let result =
      parse_args(svec!["--test", "--test-concurrency", "4"]).unwrap();
    assert!(result.options.per_isolate.per_env.test_runner);
    assert_eq!(
  ...
  fn test_test_name_pattern_option() {
    let result =
      parse_args(svec!["--test", "--test-name-pattern", "should.*work"])
        .unwrap();
    assert!(result.options.per_isolate.per_env.test_runner);
    assert_eq!(
  ...
  fn test_test_skip_pattern_option() {
    let result =
      parse_args(svec!["--test", "--test-skip-pattern", "slow"]).unwrap();
    assert!(result.options.per_isolate.per_env.test_runner);
    assert_eq!(
  ...
  fn test_watch_path_option() {
    let result =
      parse_args(svec!["--watch", "--watch-path", "./src", "script.js"])
        .unwrap();
    assert!(result.options.per_isolate.per_env.watch_mode);
    assert_eq!(
  ...
  fn test_watch_preserve_output() {
    let result =
      parse_args(svec!["--watch", "--watch-preserve-output", "script.js"])
        .unwrap();
    assert!(result.options.per_isolate.per_env.watch_mode);
    assert!(
      result
  ...
  fn test_node_options_with_escaped_quotes() {
    let env_args =
      parse_node_options_env_var("--title \"hello \\\"world\\\"\"").unwrap();
  ...
  fn test_node_options_with_backslash() {
    let env_args =
      parse_node_options_env_var("--title \"path\\\\to\\\\file\"").unwrap();
  ...
  fn test_node_options_multiple_spaces() {
    let env_args =
      parse_node_options_env_var("--no-warnings   --no-deprecation").unwrap();
  ...
  fn test_env_file_if_exists_option() {
    let result =
      parse_args(svec!["--env-file-if-exists", ".env.local", "script.js"])
        .unwrap();
    assert!(result.options.per_isolate.per_env.has_env_file_string);
    assert_eq!(
  ...
  fn test_no_extra_info_on_fatal_exception() {
    let result =
      parse_args(svec!["--no-extra-info-on-fatal-exception"]).unwrap();
    assert!(
      !result
        .options
        .per_isolate
  ...
  fn test_unknown_option_passed_to_v8() {
    ...
    let result =
      parse_args(svec!["--unknown-option-that-does-not-exist", "script.js"])
        .unwrap();
    assert!(
      result
        .v8_args

...
#[op2(fast)]
fn op_node_webstreams_closed_readable_propagates_error(
  state: &OpState,
) -> bool {
  !matches!(
    state.try_borrow::<ClosedReadableAdapterPolicy>(),
    Some(ClosedReadableAdapterPolicy::LegacyClose)
  )
}
...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::error_arrow::op_node_apply_recording_error_arrow,
    ops::error_arrow::op_node_error_arrow,
    ops::error_arrow::op_node_fatal_message_arrow,
    ...
    ops::util::op_node_get_shared_array_buffer_growable,
  ...
  lazy_loaded_js = [
    ...
    "internal/errors.ts",
    "internal/esm_builtin_gate.js",
    "internal/experimental_modules.js",
    ...
    "internal/process/fatal_report.ts",
  ...
  synthetic_esm = [
    ...
    "node:stream/iter" = "ext:deno_node/stream/iter.js",
    "node:zlib" = "ext:deno_node/zlib.js",
    "node:zlib/iter" = "ext:deno_node/zlib/iter.js",
  ],

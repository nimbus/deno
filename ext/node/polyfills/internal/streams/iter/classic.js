...
function lazyReadable() {
  if (Readable === undefined) {
    Readable =
      core.loadExtScript("ext:deno_node/internal/streams/readable.js").Readable;
  }
  return Readable;
}
...
function lazyWritable() {
  if (Writable === undefined) {
    Writable =
      core.loadExtScript("ext:deno_node/internal/streams/writable.js").Writable;
  }
  return Writable;
}
...
const { normalizeAsyncValue } = core.loadExtScript(
    ...
    write(chunk, options) {
      ...
      if (backpressure === "strict" && isFull()) {
        return PromiseReject(
          new ERR_INVALID_STATE.RangeError(

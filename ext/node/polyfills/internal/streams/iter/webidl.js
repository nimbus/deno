...
// Ported from Node.js v26.10.0 lib/internal/streams/iter/webidl.js.
...
} = core.loadExtScript("ext:deno_node/internal/webidl.js");
...
converters.WriterChunk = (value, options = { __proto__: null }) => {
  if (isUint8Array(value)) {
    return baseConverters.Uint8Array(
      value,
      allowStreamBufferOptions(options),
    );
  }
...
converters.PushStreamOptions = createDictionaryConverter(
  "PushStreamOptions",
  [budgetMember, backpressureMember, signalMember],
);
...
converters.ShareSyncOptions = createDictionaryConverter(
  "ShareSyncOptions",
  [budgetMember, backpressureMember],
);

...
class ERR_STREAM_ITER_MISSING_FLAG extends NodeTypeError {
  constructor() {
    super(
...
class ERR_VM_DYNAMIC_IMPORT_CALLBACK_MISSING_FLAG extends NodeTypeError {
  constructor() {
    super(
...
class ERR_VM_MODULE_CACHED_DATA_REJECTED extends NodeError {
  constructor() {
    super(
      "ERR_VM_MODULE_CACHED_DATA_REJECTED",
      `Cached data cannot be used to compile this module`,
    );
  }
}
...
class ERR_INVALID_STATE_TYPE_ERROR extends NodeTypeError {
  constructor(message: string) {
    super("ERR_INVALID_STATE", `Invalid state: ${message}`);
  }
}

class ERR_INVALID_STATE_RANGE_ERROR extends NodeRangeError {
  constructor(message: string) {
    super("ERR_INVALID_STATE", `Invalid state: ${message}`);
  }
}
...
class ERR_INVALID_STATE extends NodeError {
  static RangeError = ERR_INVALID_STATE_RANGE_ERROR;
  static TypeError = ERR_INVALID_STATE_TYPE_ERROR;
...
codes.ERR_ARG_NOT_ITERABLE = ERR_ARG_NOT_ITERABLE;
...
codes.ERR_STREAM_ITER_MISSING_FLAG = ERR_STREAM_ITER_MISSING_FLAG;
